...
public class ClusterNode {
    ...
    /**
     * Set to false during recovery / WAL replay so we don't serve new requests while state is being
     * reconciled.
     */
    ...
    /**
     * Actively ping the node to check if it's running. This does NOT cache state; it always calls
    ...
    /**
     * Enable or disable access to this node. When disabled, calls to sendSet/sendGet/sendDelete
